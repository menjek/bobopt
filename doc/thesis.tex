...
Abstrakt:
Cílem této diplomové práce je vytvořit nástroj na optimalizaci kódu pro paralelní prostředí Bobox. Nástroj redukuje počet krátce a dlouze běžících úloh na základě statické analýzy kódu. Některé případy krátce běžících úloh způsobují zbytečné přeplánování. Pokud plánovač nemá dostatek informací o dané úloze, plánovač může úlohu naplánovat, i když tato úloha nemá všechna potřebná vstupní data. Pro odstranění krátce běžící úlohy nástroj analyzuje použití vstupních dat a informuje plánovač. Dlouze běžící úlohy můžou v některých případech potlačit paralelismus. Větší granularita úloh může znatelně vylepšit časy běhu v paralelním prostředí. Pro odstranění dlouze běžících úloh nástroj musí byt schopen vyhodnotit složitost kódu a vložit příkaz pro přeplánování na vhodné místo.
...
.3 thesis\DTcomment{Thesis \TeX\ files and pdf}.
...
\pgfplotstabletypeset[
	...
	every head row/.style={
		before row={%
			\toprule
			& \multicolumn{3}{c}{\code{for}} & \multicolumn{3}{c}{\code{while}}\\
		},
		after row=\midrule,
	},
	...
	columns/forBody/.style  ={column name=Body},
	columns/whileBody/.style={column name=Body},
	columns/forExec/.style  ={column name=Executions},
	columns/whileExec/.style={column name=Executions},
	columns/forAvg/.style  ={column name=Average, column type/.add={>{\columncolor[gray]{.9}}}{}},
	columns/whileAvg/.style={column name=Average, column type/.add={>{\columncolor[gray]{.9}}}{}},
	col sep=&,row sep=\\,
	string type,
]{
ID & forExec  & forBody & forAvg & whileExec  & whileBody & whileAvg\\
...
\begin{tabular}{ p{7.5cm} r }
  \hhline{--}
  \cellcolor[gray]{0.9}Functions & \cellcolor[gray]{0.9}4456 \\ \hhline{--}
  Minimal complexity & 1 \\ \hhline{--}
  Maximal complexity & 473 \\ \hhline{--}
  \cellcolor[gray]{0.75}Average complexity & \cellcolor[gray]{0.75}11.457 \\ \hhline{--}
\end{tabular}
...
\begin{tabular}{ p{7.5cm} r }
  \hhline{--}
  \cellcolor[gray]{0.9}Functions & \cellcolor[gray]{0.9}978 \\ \hhline{--}
  Minimal complexity & 3 \\ \hhline{--}
  Maximal complexity & 369 \\ \hhline{--}
  \cellcolor[gray]{0.75}Average complexity & \cellcolor[gray]{0.75}41.4141 \\ \hhline{--}
\end{tabular}
