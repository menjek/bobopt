...
Abstrakt:
Cílem této diplomové práce je vytvořit nástroj na optimalizaci kódu pro paralelní prostředí Bobox. Nástroj redukuje počet krátko a dlouho běžících úloh na základě statické analýzy kódu. Některé případy krátce běžících úloh způsobují zbytečné přeplánování. Plánovač může úlohu naplánovat, i když tato úloha nemá všechny potřebné vstupné data. Pokud, plánovač nemá dostatek informací o dané úloze. Pro odstranění krátce běžící úlohy, nástroj analyzuje použití vstupních dat a informuje plánovač. Dlouho běžící úlohy můžou v některých případech potlačit paralelismus. Větší granularita úloh může znatelně vylepšit časy běhu v paralelním prostředí. Pro odstranění dlouho běžících úloh, nástroj musí byt schopen vyhodnotit složitost kódu a vložit příkaz pro přeplánování na vhodné místo.
