...
namespace bobopt
{
    ...
    public:
        ...
        BOBOX_BOX_INPUTS_LIST(main, 0);
        BOBOX_BOX_OUTPUTS_LIST(out0, 0, out1, 1, out2, 2, out3, 3, out4, 4, out5, 5, out6, 6, out7, 7, out8, 8, out9, 9, next, 10);
        ...
        virtual void sync_body() BOBOX_OVERRIDE
        {
            ...
            if (env_in->is_poisoned())
            {
                ...
                send_poisoned(outputs::out8());
                send_poisoned(outputs::out9());
            ...
            bench_send_envelope(this, outputs::out8(), in);
            bench_send_envelope(this, outputs::out9(), in);
    ...
    public:
        ...
        BOBOX_BOX_INPUTS_LIST(main, 0);
        BOBOX_BOX_OUTPUTS_LIST(out0, 0, out1, 1, out2, 2, out3, 3, out4, 4, out5, 5, out6, 6, out7, 7, out8, 8, out9, 9);
    ...
    public:
        ...
        BOBOX_BOX_INPUTS_LIST(in0, 0, in1, 1, in2, 2, in3, 3, in4, 4, in5, 5, in6, 6, in7, 7, in8, 8, in9, 9);
        BOBOX_BOX_OUTPUTS_LIST(main, 0);
        ...
        virtual void sync_body() BOBOX_OVERRIDE
        {
            ...
            auto env_in8 = pop_envelope(inputs::in8());
            auto env_in9 = pop_envelope(inputs::in9());

            if (env_in0->is_poisoned() || env_in1->is_poisoned() || env_in2->is_poisoned() || env_in3->is_poisoned() || env_in4->is_poisoned() ||
                env_in5->is_poisoned() || env_in6->is_poisoned() || env_in7->is_poisoned() || env_in8->is_poisoned() || env_in9->is_poisoned())
            {
                send_poisoned(outputs::main());
                return;
            }
            ...
            auto in1 = *(env_in1->get_column(column_index_type(0)).get_data<unsigned>());
            auto in2 = *(env_in2->get_column(column_index_type(0)).get_data<unsigned>());
            auto in3 = *(env_in3->get_column(column_index_type(0)).get_data<unsigned>());
            auto in4 = *(env_in4->get_column(column_index_type(0)).get_data<unsigned>());
            auto in5 = *(env_in5->get_column(column_index_type(0)).get_data<unsigned>());
            auto in6 = *(env_in6->get_column(column_index_type(0)).get_data<unsigned>());
            auto in7 = *(env_in7->get_column(column_index_type(0)).get_data<unsigned>());
            auto in8 = *(env_in8->get_column(column_index_type(0)).get_data<unsigned>());
            auto in9 = *(env_in9->get_column(column_index_type(0)).get_data<unsigned>());

            bench_send_envelope(this, outputs::main(), in0 + in1 + in2 + in3 + in4 + in5 + in6 + in7 + in8 + in9);
        }
    };
